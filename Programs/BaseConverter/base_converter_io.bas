...
110 PRINT ""
120 PRINT "BASE CONVERTER - DIGITAL I/O"
130 PRINT "============================"
140 PRINT "Converts one-byte values between bases."
150 PRINT "The LEDs show the value as an 8-bit binary number."
160 PRINT ""
170 OUT IP, 0
...
370 OUT IP, N
380 PRINT "LED byte:    "; N
390 PRINT ""
400 GOTO 210
500 REM Clear the LEDs before leaving the program
510 OUT IP, 0
