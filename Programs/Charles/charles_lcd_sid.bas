10 REM Charles the Feisty Octopus - LCD version with SID chirps
...
5670 NEXT LC
5680 RETURN
5900 REM LCD delay in short slices so a chirp stays rapid
5910 FOR LQ = 1 TO 10
5912 FOR SW = 1 TO 10 : NEXT SW
5914 IF SA <> 0 THEN GOSUB 9600
5916 NEXT LQ
5920 RETURN
...
7035 PRINT
7040 GOSUB 9700 : INPUT "ACTION "; AC$
