10 REM Charles the Feisty Octopus - Phases 1 to 4
20 REM Needs, moods, interaction, memory, and feistiness
...
125 PRINT "=========================="
127 PRINT
130 PRINT "MEMORY AND FEISTINESS - PHASE 4"
140 PRINT
...
490 REM SO is sociability; CI is the personality-adjusted cross level
500 GOSUB 3500
510 GOSUB 4000
520 GOSUB 2000
530 GOSUB 5000
...
2010 PRINT "--------------------------------------------------"
2020 PRINT "MOOD "; SN$(MO);" NEEDS: ";
2022 LET NS = 0
2023 IF HU >= NH THEN PRINT "HUNGRY "; : LET NS = 1
2024 IF BO >= NB THEN PRINT "BORED "; : LET NS = 1
2025 IF EN <= NE THEN PRINT "TIRED "; : LET NS = 1
2026 IF CR = 1 THEN PRINT "CROSS "; : LET NS = 1
2027 IF NS = 0 THEN PRINT "NONE";
2028 PRINT ""
2030 PRINT "HUNGER: "; HU; " HAPPY: "; HA;
2040 PRINT " ENERGY: "; EN; " BORED: "; BO;
2050 PRINT " IRRITATION: "; IR
2140 RETURN
...
7050 IF AC$ = "F" OR AC$ = "f" THEN LET AK = 1 : GOTO 7120
7060 IF AC$ = "P" OR AC$ = "p" THEN LET AK = 2 : GOTO 7120
7070 IF AC$ = "T" OR AC$ = "t" THEN LET AK = 3 : GOTO 7120
7080 IF AC$ = "A" OR AC$ = "a" THEN LET AK = 4 : GOTO 7120
7090 IF AC$ = "W" OR AC$ = "w" THEN GOTO 7180
7100 PRINT "ENTER F, P, T, A OR W."
7110 GOTO 7030
7120 GOSUB 6800
7130 IF AK = 1 THEN GOSUB 7400
7140 IF AK = 2 THEN GOSUB 7600
7150 IF AK = 3 THEN GOSUB 7800
7160 IF AK = 4 THEN GOSUB 8200
7170 GOTO 7200
7180 LET LA = 0 : LET RP = 0
7190 PRINT "TIME PASSES." : RETURN
7200 GOSUB 8400
7210 GOSUB 4000
