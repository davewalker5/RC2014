10 REM Charles the Feisty Octopus - Phases 1 to 3
20 REM Needs, moods, opinions, and interaction for RC2014 BASIC
...
100 LET CM = 80 : LET CI = 80 : REM Cross thresholds
110 PRINT
120 PRINT "CHARLES THE FEISTY OCTOPUS"
130 PRINT "NEEDS, OPINIONS AND ACTIONS - PHASE 3"
140 PRINT
150 PRINT "FEED, PLAY, PET OR ANNOY CHARLES."
160 PRINT "CHOOSE WAIT TO LET TIME PASS."
170 PRINT "PRESS CTRL-C AT A PROMPT TO STOP."
180 PRINT
190 DIM SN$(5), ME$(5, 3)
...
530 GOSUB 4000
540 LET DC = DC + 1
550 IF DC < DI THEN GOTO 600
560 LET DC = 0
570 GOSUB 2000
580 GOSUB 7000
600 LET MC = MC + 1
610 IF MO <> PS THEN GOTO 640
620 IF MC < MI THEN GOTO 660
640 GOSUB 5000
650 LET MC = 0
660 GOSUB 6000
670 GOTO 500
...
2110 IF CR = 1 THEN PRINT "CROSS "; : LET NS = 1
...
4070 IF EN <= NE THEN LET MO = 4 : REM Sleepy
4080 RETURN
...
7010 PRINT
7020 PRINT "F FEED  P PLAY  T PET  A ANNOY  W WAIT"
7030 INPUT "ACTION"; AC$
7040 LET OM = MO : REM Preserve the mood before the action
7050 IF AC$ = "F" OR AC$ = "f" THEN GOSUB 7200 : GOTO 7120
7060 IF AC$ = "P" OR AC$ = "p" THEN GOSUB 7400 : GOTO 7120
7070 IF AC$ = "T" OR AC$ = "t" THEN GOSUB 7600 : GOTO 7120
7080 IF AC$ = "A" OR AC$ = "a" THEN GOSUB 7800 : GOTO 7120
7090 IF AC$ = "W" OR AC$ = "w" THEN PRINT "TIME PASSES." : RETURN
7100 PRINT "ENTER F, P, T, A OR W."
7110 GOTO 7030
7120 GOSUB 8000
7130 GOSUB 4000
7140 LET PS = MO : LET MC = 0
7150 GOSUB 2000
7160 RETURN
7200 REM Feed Charles according to his current hunger and mood
7210 IF HU < 80 THEN GOTO 7260
7220 LET HU = HU - 100 : LET HA = HA + 20
7230 LET EN = EN + 10
7240 IF OM = 5 THEN PRINT "CHARLES: ABOUT TIME." : RETURN
7250 PRINT "CHARLES: CRAB! EXCELLENT." : RETURN
7260 LET IR = IR + 15 : LET HA = HA - 5
7270 PRINT "CHARLES: NO. I AM FULL."
7280 RETURN
7400 REM Play unless Charles is hungry or too tired
7410 IF EN < 70 THEN PRINT "CHARLES: TOO TIRED." : RETURN
7420 IF HU >= NH THEN LET IR = IR + 5 : GOTO 7470
7430 LET BO = BO - 100 : LET HA = HA + 25
7440 LET EN = EN - 30
7450 IF OM = 5 THEN PRINT "CHARLES: FINE. ONE GAME." : RETURN
7460 PRINT "CHARLES: AGAIN!" : RETURN
7470 PRINT "CHARLES: FEED ME FIRST."
7480 RETURN
7600 REM Petting usually cheers Charles unless he is cross
7610 IF OM = 5 THEN GOTO 7650
7620 LET HA = HA + 15 : LET IR = IR - 20
7630 PRINT "CHARLES: ACCEPTABLE."
7640 RETURN
7650 LET HA = HA - 5 : LET IR = IR + 10
7660 PRINT "CHARLES: DO NOT TOUCH ME."
7670 RETURN
7800 REM Annoying Charles reduces happiness and raises irritation
7810 LET HA = HA - 30 : LET IR = IR + 80
7820 LET BO = BO - 10
7830 IF OM = 5 THEN PRINT "CHARLES: YOU AGAIN." : RETURN
7840 PRINT "CHARLES: THAT WAS UNWISE."
7850 RETURN
8000 REM Clamp all need values to the zero-to-255 range
8010 IF HU < 0 THEN LET HU = 0
8020 IF HU > 255 THEN LET HU = 255
8030 IF HA < 0 THEN LET HA = 0
8040 IF HA > 255 THEN LET HA = 255
8050 IF EN < 0 THEN LET EN = 0
8060 IF EN > 255 THEN LET EN = 255
8070 IF BO < 0 THEN LET BO = 0
8080 IF BO > 255 THEN LET BO = 255
8090 IF IR < 0 THEN LET IR = 0
8100 IF IR > 255 THEN LET IR = 255
8110 RETURN
