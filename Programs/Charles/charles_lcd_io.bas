10 REM Charles the Feisty Octopus - Phase 7 LCD and Digital IO
...
130 PRINT "=========================="
140 PRINT
170 PRINT "BUTTON VALUES: 1 FEED, 2 PLAY,";
180 PRINT " 4 PET, 8 ANNOY. PRESS ONE BUTTON."
190 PRINT "CHARLES LIVES ON THE LCD. CTRL-C STOPS."
200 PRINT
210 DIM SN$(6), ME$(6, 3)
...
7050 PRINT "PRESS ONLY ONE DIGITAL IO BUTTON."
7060 GOSUB 7300
7070 RETURN
7090 LET OM = MO : LET AK = 0
7100 IF BK = 1 THEN LET AK = 1 : REM Feed
7110 IF BK = 2 THEN LET AK = 2 : REM Play
7120 IF BK = 4 THEN LET AK = 3 : REM Pet
7130 IF BK = 8 THEN LET AK = 4 : REM Annoy
7140 GOSUB 6800
7150 IF AK = 1 THEN GOSUB 7400
7160 IF AK = 2 THEN GOSUB 7600
7170 IF AK = 3 THEN GOSUB 7800
7180 IF AK = 4 THEN GOSUB 8200
7190 GOSUB 8400
7200 GOSUB 4000
7210 LET PS = MO : LET MC = 0
7220 GOSUB 2500
7230 GOSUB 7300
7240 RETURN
