...
40 LET N = 6
50 LET IP = 1 : OUT IP, 0
60 LET LR = 218 : LET LD = 219
70 GOSUB 3000
...
155 PRINT "LED 0 shows class; LEDs 1-7 stay off."
...
510 GOSUB 2000
520 PRINT "Press RETURN for the next step"; : INPUT A$
530 NEXT I
600 PRINT ""
...
1660 LET TX$ = "UPDATE" + STR$(EP)
1670 LET LC = 128 : GOSUB 3500
1680 LET TX$ = "OF" + STR$(NE) : LET LC = 192 : GOSUB 3500
1690 RETURN
...
3050 LET TX$ = "TRAINABLE NEURON"
3060 LET LC = 128 : GOSUB 3500
3070 LET TX$ = "TRAINING..."
...
3560 NEXT J
3570 RETURN
3900 REM Same conservative LCD delay as Programs/Neuron
3910 FOR QD = 1 TO 100 : NEXT QD
3920 RETURN
