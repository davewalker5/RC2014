// Local consumers index five column bytes per character; bit 0 is the top dot.
// LCD custom glyphs use their own CGRAM data instead of this built-in font.
// Preserve the upstream bitmap data and the attribution in LICENSE.font.
